 ...
 const confirmCode = async () => {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <TouchableOpacity onPress={() => router.back()} style={{ marginTop: '-13%' }} >
...
const styles = StyleSheet.create({
  ...
  toggleContainer: { flexDirection: 'row', backgroundColor: '#f0f0f0', borderRadius: 10, marginTop: 10, padding: 5 },
